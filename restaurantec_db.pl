...
restaurante(kfc, comida_rapida,[sanjose, 'San Pedro'],20,'el uso de mascarilla obligatorio').
...
restaurante(kfc, comida_rapida,[cartago, '50 mts al sur de las Ruinas'],20,'el uso de mascarilla obligatorio').
restaurante(linfei,china,[cartago, '200 mts al este de la Basilica de Los Angeles'],20,'el uso de mascarilla obligatorio').

%Puntarenas
restaurante(mcdonald, comida_rapida, [puntarenas, 'Plaza Centenario'], 30, 'el uso de mascarilla obligatorio').
restaurante(rostipollos, comida_rapida, [puntarenas, 'Hotel Alamar'], 30, 'el uso de mascarilla obligatorio').
...
restaurante(kfc, comida_rapida,[puntarenas, 'Puntarenas Down Town'],20,'el uso de mascarilla obligatorio').
...
%Alajuela
restaurante(mcdonald, comida_rapida, [alajuela, 'Diagonal Bomba Provincia de Alajuela La Tropicana, Provincia de Alajuela'], 30, 'el uso de mascarilla obligatorio').
...
restaurante(kfc, comida_rapida,[alajuela, 'Cruce calle 2 Obispo Tristán y avenida 10 Jesús Ocaña'],20,'el uso de mascarilla obligatorio').
...
%Guanacaste
restaurante(mcdonald, comida_rapida, [guanacaste, 'Carretera Interamericana Esq, Av. Central, Provincia de Guanacaste, Liberia'], 30, 'el uso de mascarilla obligatorio').
...
restaurante(kfc, comida_rapida,[guanacaste, 'Diagonal a Plaza Santa Rosa, Liberia, Guanacaste, Provincia de Guanacaste, Liberia'],20,'el uso de mascarilla obligatorio').
...
%Limon
restaurante(mcdonald, comida_rapida, [limon, 'Calle 8, Limon'], 30, 'el uso de mascarilla obligatorio').
...
restaurante(kfc, comida_rapida,[limon, 'Centro de Limon'],20,'el uso de mascarilla obligatorio').
...
menu(arroz,[hongkong,linfei,wingshun],[chino,conPollo,cantones]).

menu(pollo, [kfc,rostipollos], [crispy, frito]).
menu(pollos, [kfc,rostipollos], [crispy, frito]).

menu(pescado,[fishy,marisqueando],[fileteado, empanizado, crispy]).
menu(ceviche,[fishy,marisqueando],[conLimon]).
